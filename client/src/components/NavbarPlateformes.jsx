    ...
    const renderContent = () => {
        if (style !== 'search_on') {
            return (
                ...
                <a className={'nav_container_section nav_nintendo_section'} href={'#'}>
                    <div className={'nintendo_img_container nav_ico'}><img src={nintendo} alt="nintendo"/></div>
                    <span>Nintendo</span>
                </a>
                <div className={'nav_container_section nav_plateformes_search'} onClick={handleCLick}>
            ...
            return (
                ...
                <form className={'nav_form_search'} action="get">
                    <input className={'nav_input_search'} type="text" placeholder={'Search a game'}/>
                </form>
                    <a className={'nav_advanced_search'} href="#">Recherche avancée</a>
                <i className="fa-solid fa-xmark nav_plateformes_search_exit" onClick={handleCLick}></i>
                </>
            )
        }
    }
